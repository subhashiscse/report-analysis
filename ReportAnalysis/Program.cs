...
namespace ZurichPOIApp
{
    class Program
    {
        ...
        {
            string connectionString = "Host=10.5.6.34;Port=5432;Database=post;Username=postgres;Password=bg@123#$%";
...
//             "Host=10.5.6.34;Port=5432;Database=post;Username=postgres;Password=bg@123#$%";
//         await using var conn = new NpgsqlConnection(connectionString);
//         await conn.OpenAsync();
//
//         // string query = @"
